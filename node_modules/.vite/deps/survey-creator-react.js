...
var SurveyQuestionMatrixDropdownBase = class extends SurveyQuestionElementBase {
  ...
  renderTableDiv() {
    return React.createElement(
      "div",
      { className: this.question.cssClasses.tableWrapper, "data-sv-drop-target-matrix-row": this.question.renderedTable.wrapperDropTargetId, ref: (root) => this.setControl(root) },
...
var SurveyQuestionSignaturePad = class extends SurveyQuestionElementBase {
  ...
  renderCleanButton() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "button",
        { type: "button", className: cssClasses.clearButton, title: this.question.clearButtonCaption, onClick: () => this.question.clearValue(true) },
...
var SearchComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return React2.createElement(
      ...
      React2.createElement("input", { type: "text", className: "svc-search__input", "aria-label": this.model.filterStringPlaceholder, placeholder: this.model.filterStringPlaceholder, value: this.state.filterString, onChange, tabIndex: this.model.getTabIndex() }),
      React2.createElement(
        "div",
...
var TabDesignerComponent = class extends SurveyElementBase {
  ...
  createRenderedPage(page, className, isGhostPage) {
    return React2.createElement(PageWrapperComponent, { key: page === null || page === void 0 ? void 0 : page.id, page, isGhost: isGhostPage, creator: this.creator, className });
  }
  renderElement() {
...
var PageWrapperComponent = class _PageWrapperComponent extends React2.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return React2.createElement("div", { className: this.props.className, "data-sv-drop-target-page": (_a = this.props.page) === null || _a === void 0 ? void 0 : _a.name, "data-sv-drop-target-survey-element": this.props.isGhost ? "newGhostPage" : (_b = this.props.page) === null || _b === void 0 ? void 0 : _b.name }, pageContent);
  }
  setupCallback(page) {
    if (!page)
      return;
...
var Version;
Version = `${"2.3.7"}`;
checkLibraryVersion(`${"2.3.7"}`, "survey-creator-react");
export {
  ActionButton,
  AdaptiveToolbox,
